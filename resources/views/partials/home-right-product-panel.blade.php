  ...
  <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
      ...
      <div class="tab-content outer-top-xs">
       <div class="row">
              ...
              @foreach($products as $key2 => $product)    
               <div style="visibility: visible;" class="col-sm-6 col-md-3 wow fadeInUp animated">
                     <div class="products">
                    <div class="product">
    ...
    <div class="wide-banners wow fadeInUp outer-bottom-xs animated" style="visibility: visible; animation-name: fadeInUp;">
          <div class="row">
            <div class="col-md-12">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img class="img-responsive" src="{{ asset('public/enduser/assets/images/banners/home-banner-1.png') }}" alt="" width="100%;"> </div>
                           <div class="new-label">
      ...
      <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
           ...
           @foreach($categories as $key => $value)  
            @foreach($product_new as $key2 => $product) 
                 ...
                 @if($product->product_category==$value['id'])
                 <div class="item item-carousel">
                  <div class="products">
                    <div class="product">
                      <div class="product-image">
