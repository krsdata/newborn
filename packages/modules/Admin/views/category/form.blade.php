...
<div class="col-md-12">
    ...
    <div class="form-group{{ $errors->first('category_name', ' has-error') }}">
        <label class="col-lg-2 col-md-2 control-label"> Box Name <span class="error">*</span></label>
...
<div class="col-md-12">
    ...
    <div class="form-group{{ $errors->first('description', ' has-error') }}">
        <label class="col-lg-2 col-md-2 control-label">Box Description</label>
        <div class="col-lg-8 col-md-8"> 
    ...
    <div class="form-group">
        ...
        <div class="col-lg-8 col-md-8">
            ...
            {!! Form::submit(' Add Box ', ['class'=>'btn  btn-primary text-white','id'=>'saveBtn']) !!}
